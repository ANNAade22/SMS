    ...
    await Event.create([
      {
        ...
        type: 'meeting',
        organizer: pick(teachers)._id,
        attendees: teachers.slice(0, 5).map((t) => t._id),
        isPublic: true,
      },
      {
        title: 'Science Fair',
        ...
        type: 'event',
        organizer: pick(teachers)._id,
        attendees: students.slice(0, 30).map((s) => s._id),
        isPublic: true,
      },
    ]);
