...
interface DataTableProps<TData, TValue> {
  ...
  onRecordPayment?: (assignment: any) => void;
  loading?: boolean;
}
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-amber-100 mt-1">
              Manage fee assignments and track payment status
            </p>
          </div>
      ...
      <div className="flex items-center justify-between py-4 bg-amber-900/10 backdrop-blur-sm rounded-lg border border-amber-700/30 px-6 shadow-lg">
        <div className="flex items-center space-x-4">
          ...
          <select
            ...
            className="h-10 px-4 py-2 border border-amber-600/50 bg-amber-50/90 rounded-md text-sm text-amber-900 focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
          >
                ...
                >
                  <div className="flex flex-col items-center justify-center space-y-2">
                    ...
                    <p className="text-sm text-amber-600">
                      Start by creating your first fee assignment
                    </p>
                  </div>
                </TableCell>
              </TableRow>
