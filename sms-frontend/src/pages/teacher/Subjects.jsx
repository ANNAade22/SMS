...
const Subjects = () => {
  ...
  const subjects = allSubjects.filter((subject) =>
    subject.teachers?.some((teacher) => teacher._id === teacherProfile?._id)
  );
  ...
  if (teacherLoading || subjectsLoading) {
    return (
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">View the subjects you teach</p>
      </div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">
                  {Array.isArray(viewingSubject.teachers)
                    ? viewingSubject.teachers.length
                    : 0}{" "}
                  assigned
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">
                  {Array.isArray(viewingSubject.lessons)
                    ? viewingSubject.lessons.length
                    : 0}{" "}
                  scheduled
                </p>
              </div>
